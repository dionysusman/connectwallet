            ...
            <div className="move container">
                <div className="d-block py-5 position-relative">
                    ...
                    <div className="d-block text-center pt-3 pb-3">
                        ...
                        <a href="https://opensea.io" className="social-icon px-3" target="_blank" rel="noopener noreferrer">
                            <img src={OpenseaImg} alt="OpenSea Logo" width="32px" title="OpenSea" />
                        </a>
                        <a href="https://t.me/cryptogolf_io" className="social-icon px-3" target="_blank" rel="noopener noreferrer">
                            <img src={TelegramImg} alt="OpenSea Logo" width="32px" title="OpenSea" />
                        </a>
                    </div>
