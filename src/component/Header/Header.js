...
const Header = ({
    ...
    const handleClickMenu = async (id) => {
                ...
                <div className="container">
                    <div className="position-relative">
                        <nav className="navbar pt-3 px-0 px-sm-3 navbar-toggleable-md navbar-inverse d-flex align-items-center justify-content-between">
                            <Link className="navbar-brand Tanker mr-2 position-relative" to="/">
                            ...
                            <div className="d-flex justify-content-between align-items-center">
                                ...
                                <div className="d-flex align-items-center">
                                    <div className="d-none d-xl-block mr-2">
                                        ...
                                        <a href="https://opensea.io" className="social-icon mx-1" target="_blank" rel="noopener noreferrer">
                                            <img src={OpenseaImg} alt="OpenSea Logo" width="28px" title="OpenSea" />
                                        </a>
                                        <a href="https://t.me/cryptogolf_io" className="social-icon mx-1" target="_blank" rel="noopener noreferrer">
                                            <img src={TelegramImg} alt="OpenSea Logo" width="28px" title="OpenSea" />
                                        </a>
                                    </div>
                                    <div>
                                        {
                                                ...
                                                <div className="position-relative mx-1">
                                                    ...
                                                    </button>
                                                    {
                                                        header_dropdown_menu && (
                                                            <div className="wallet-status-show py-1 px-1" ref={dropdownRef}>
