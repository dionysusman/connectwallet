                ...
                <div className="d-flex flex-row percent-height100">
                    ...
                    <div className="col-12 col-lg-6 pl-0 pr-0 pl-lg-5 position-relative">
                        <div className="d-flex flex-row">
                            ...
                            <p className="text-left percent-script color-grey pl-2">At SOLD OUT the full version of the marketplace will go live. We will start to develop the online golf course tee time booking App and step up marketing campaigns and expansion of golf course partnerships worldwide.</p>
                        </div>
                        <div className="position-absolute loadmap-key1 d-none d-lg-block">
