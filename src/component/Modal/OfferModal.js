...
const OfferModal = ({
    ...
    useEffect(() => {
        const getGolfBalance = async () => {
            ...
            const golfInst = new web3.eth.Contract(golfContractAbi, GOLFContractAddress);
        ...
        if (walletAddress !== null && chainId === 56) {
            getGolfBalance()
        }
    ...
    const handlePlaceOffer = async (e) => {
        ...
        if (tokenType === 1) {
            ...
            const web3 = new Web3(Web3.givenProvider || "http://localhost:8545");
            const golfContract = new web3.eth.Contract(golfContractAbi, GOLFContractAddress);
        ...
        <Styles>
            <Modal show={show} onHide={handleClose}>
                ...
                <Modal.Body className="p-4" style={{ padding: '1.5rem !important' }}>
                    {
                        chainId === 56 && <div className="text-left mx-4 mt-3 font-small">
                            <Form.Check
                                inline
                                label="BNB"
                                name="group1"
